...
enum ActionsFilter {
    ...
    static func emptyMessage(filter:String,meetingOpen:Int)->String {
        if filter=="mine" && meetingOpen>0 { return "Bu toplantıda \(meetingOpen) açık görev var ama hiçbiri size atanmamış." }
        return "İsimsiz görevler Tüm görevler altında görünür; sahibini kaynakla doğrulayarak düzeltebilirsiniz."
    }
