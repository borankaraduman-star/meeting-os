...
final class UpdaterTests:XCTestCase {
    func testHeadlinesAndSettingsRoundTrip() {
        ...
        XCTAssertEqual(s.changes as NSDictionary,["share_reports":false,"share_text":false,"auto_update":true,"report_dir":"/x","audio_retention_days":30,"user_name":"Ayşe","team_dir":"","share_glossary":true] as NSDictionary)
