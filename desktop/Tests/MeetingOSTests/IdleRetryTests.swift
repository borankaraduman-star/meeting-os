...
final class IdleRetryTests: XCTestCase {
    ...
    func testBlockedHintNamesTheFixAndStaysQuiet() {
        ...
        XCTAssertEqual(IdleRetry.blockedHint([["kind":"credit"]]),"OpenRouter kredisi bitti · 1 toplantı bekliyor · Ayarlar → OpenRouter")
        XCTAssertEqual(IdleRetry.blockedHint([["kind":"auth"],["kind":"auth"]]),"OpenRouter anahtarı geçersiz · 2 toplantı bekliyor · Ayarlar → OpenRouter")
