...
- **Kimin yazımı geçerli:** kendi öğrettiğiniz yazım her zaman, sessizce önceliklidir. İki ekip arkadaşı aynı kelimeyi **farklı** öğretmişse ve sizde kendi kuralınız yoksa **hiçbiri uygulanmaz** (1.2.84 öncesinde en yeni satır kazanıyordu): Kontrol’e “Ekipte iki yazım: X / Y — hangisi?” maddesi gelir, seçtiğiniz yazım yalnız bu Mac’te öğrenilir ve ekip klasöründeki satırlara dokunulmaz. İkisi de listede, öğreten Mac’in adıyla görünmeye devam eder. İki Mac aynı yazımı öğretmişse bu bir çatışma değildir, eskisi gibi uygulanır.
