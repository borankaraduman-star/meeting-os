# OpenRouter üzerinden GPT Transcribe
...
3. Dosyayı ve başlığı seçin. Gönderim/ücret kutusunu işaretleyip **Yükle ve yazıya çevir**.
...
```sh
.venv/bin/python -m meeting_os openrouter-import '/absolute/path/meeting.m4a' --title 'Toplantı' --allow-upload
